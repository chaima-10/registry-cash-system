...
-- AlterTable
ALTER TABLE `CartItem` ADD COLUMN `priceTTC` DECIMAL(10, 2) NOT NULL DEFAULT 0.00;

-- AlterTable
ALTER TABLE `Sale` ADD COLUMN `exchangeRate` DECIMAL(10, 4) NOT NULL DEFAULT 1.0000;

-- AlterTable
ALTER TABLE `SaleItem` ADD COLUMN `priceTTC` DECIMAL(10, 2) NOT NULL DEFAULT 0.00;
